...
class TestGuiSmoke(unittest.TestCase):
    ...
    def test_settings_round_trip(self):
        ...
        idx_cont = w1._acquisition_mode_combo.findData("continuous")
        ...
        self.assertEqual(w2._selected_acquisition_mode(), "continuous")
        self.assertAlmostEqual(w2._continuous_window_sec_spin.value(), 900.0, places=1)
        self.assertAlmostEqual(w2._continuous_step_sec_spin.value(), 900.0, places=1)
        self.assertTrue(w2._allow_partial_final_window_cb.isChecked())
        self.assertFalse(w2._sph_edit.isEnabled())
        self.assertFalse(w2._duration_edit.isEnabled())
